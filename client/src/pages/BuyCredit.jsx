...
const BuyCredit = () => {
    ...
    return (
        <div className='min-h-[80vh] text-center p-14 nv-10'>
            ...
            <div className='flex flex-wrap justify-center gap-6 text-left'>
                {
                    plans.map((item, index) => (
                        <div key={index} className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-700 hover:scale-105 transition-all duration-300'>
